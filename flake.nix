{
  ...
  inputs = {
    ...
    blockchain-k-plugin.url = "github:runtimeverification/blockchain-k-plugin/1b098f050b4317fd42e5c8c8382ea738b4f98997";
    ...
    pyk.url = "github:runtimeverification/pyk/v0.1.200";
