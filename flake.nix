{
  ...
  inputs = {
    ...
    blockchain-k-plugin.url = "github:runtimeverification/blockchain-k-plugin/860f231fb73b11937eba01f68206af5fe942514b";
    ...
    pyk.url = "github:runtimeverification/pyk/v0.1.183";
